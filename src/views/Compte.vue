<template>
  <section>
    <Navbar/>
    <Hero msg = "Mon Compte" sub_msg = "Mes informations personnelles :"/>
    <div class="columns is-mobile" style="margin-top: 1rem;">
      <div class="column is-three-fifths is-offset-one-fifth">
        
          <div class="box">
            <h3 class="subtitle is-3">Informations générales</h3>
            <p id="sous">Certaines de ces informations peuvent être vues par les autres utilisateurs des services Google.</p>
            <ul class="liste">
